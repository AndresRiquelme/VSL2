...
ivregress 2sls $y $controls ($x = $instrumentos)if $filter & year==2009
estimates store iv_iid

* Second Model:
* Heteroskedasticity robust standard errors
ivregress 2sls $y $controls ($x = $instrumentos) if $filter & year==2009, vce(robust)
estimates store iv_het
...
*********************** BETWEEN **********************
estimates restore iv_iid
scalar table_column = 10
